      ...
      {showModal ? (
        <>
          <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
            <div className="relative w-auto my-6 mx-auto max-w-2xl px-12">
              {/*content*/}
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className=" p-6  flex-auto ">
                  <div>
                    <label
                      for="grievances"
                      class="block text-sm font-medium text-gray-700 text-center lg:text-left"
                    >
                      Select Grievances
                    </label>
                    <select class="mt-4 border py-3 ">
                      <option selected>Waste Not Collected</option>
                      <option>
                        Collected but WW mixed the segregated waste
                      </option>
